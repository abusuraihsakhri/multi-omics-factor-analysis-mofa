...
**Multi Omics Factor Analysis MOFA** is an advanced analytical and computational platform implementing Multi-Omics Factor Analysis (MOFA+) Bayesian group factor variance decomposer.
...
docker run -p 8000:8000 multi-omics-factor-analysis-mofa
```

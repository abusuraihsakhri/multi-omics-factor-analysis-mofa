"""
Automated Pytest for multi-omics-factor-analysis-mofa Enrichment Modules.
"""
import sys
...
from enrichment import (
    ...
    MultiomicsfactoranalysismofaEnrichmentSuite,
    enrichment_suite,
)

def test_enrichment_suite_execution():
    suite = MultiomicsfactoranalysismofaEnrichmentSuite()

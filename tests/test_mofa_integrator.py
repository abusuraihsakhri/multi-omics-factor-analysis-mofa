...
import pytest
from mofa_integrator.models import FrontierPayload, ExecutionStatus
from mofa_integrator.engine import FrontierDomainEngine
from mofa_integrator.agents import BayesianGroupFactorAgent, VarianceDecompositionAgent, ClinicalCovariateCorrelatorAgent, MOFACoordinator
from mofa_integrator.cli import main


def test_sub_agents():
    a1 = BayesianGroupFactorAgent()
    ...
    a3 = ClinicalCovariateCorrelatorAgent()
...
def test_coordinator():
    ...
    assert "Multi-Omics Factor Analysis (MOFA+) Framework" in ans or "specifications" in ans

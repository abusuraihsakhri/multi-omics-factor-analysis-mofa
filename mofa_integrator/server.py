"""
FastAPI REST API Server for MOFA-Integrator: Multi-Omics Factor Analysis & Variance Decomposition Agent.
"""
...
def create_app():
    try:
        ...
        app = FastAPI(
            title="MOFA-Integrator: Multi-Omics Factor Analysis & Variance Decomposition Agent",
            description="Integrates transcriptomics, proteomics, and metabolomics matrices via Bayesian group factor analysis, decomposing variance per biological factor.",
        ...
        @app.get("/health")
        def health():
            return {"status": "HEALTHY", "system": "multi-omics-factor-analysis-mofa", "domain": "Biomedical Scientific Discovery & Multi-Omics", "version": "2.0.0-FRONTIER"}
